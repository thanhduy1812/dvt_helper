...
class GtdDashDecoration extends Decoration {
  ...
  const GtdDashDecoration(
      {this.shape = Shape.line,
      this.linePosition = LinePosition.bottom,
      this.color = const Color(0xFF9E9E9E),
      this.fillColor,
      this.borderRadius,
      this.dash = const <int>[3, 3],
      this.strokeWidth = 1});

  @override
  BoxPainter createBoxPainter([VoidCallback? onChanged]) {
    return _DottedDecotatorPainter(shape, linePosition, color, fillColor, borderRadius, dash, strokeWidth);
  }
}
...
class _DottedDecotatorPainter extends BoxPainter {
  ...
  _DottedDecotatorPainter(
      this.shape, this.linePosition, this.color, this.fillColor, this.borderRadius, this.dash, this.strokeWidth) {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    if (fillColor != null) {
      ...
      canvas.drawPath(outPath, fillPaint);
    }
